...
..\..\isd_download.exe -tonorflash -dev br23 -boot 0x12000 -div8 -wait 300 -uboot uboot.boot -app app.bin  -res tone.cfg cfg_tool.bin eq_cfg_hw.bin %1 config.dat md5.bin 
:: -format all
::-reboot 2500
