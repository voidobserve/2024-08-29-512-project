...
const u16 bt_key_ad_table[KEY_AD_NUM_MAX][KEY_EVENT_MAX] = {
    ...
    [2] = {
        KEY_REVERB_SWITCH, KEY_CALL_HANG_UP,		KEY_NULL,	KEY_NULL,		KEY_CALL_LAST_NO,			KEY_NULL
    },
    [3] = {
        KEY_VOL_UP,	KEY_VOL_UP,			KEY_VOL_UP,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
    [4] = {
        KEY_REVERB_OPEN,		KEY_REVERB_OPEN,			KEY_NULL,			KEY_NULL,		KEY_REVERB_OPEN,	KEY_NULL
    },
    [5] = {
        KEY_NULL,		KEY_REVERB_SWITCH,			KEY_NULL,			KEY_NULL,		KEY_ENC_START,		KEY_NULL
    },
    [6] = {
        KEY_NULL,		KEY_NULL,			KEY_NULL,			KEY_NULL,		KEY_NULL,			KEY_NULL
    },
