...
#ifdef CONFIG_BOARD_AC6951_KGB_V1
...
/* #endif */
	...
	gpio_set_pull_up(MUTE_ABD_PORT1, 0);
	gpio_set_pull_down(MUTE_ABD_PORT1, 0);
	gpio_set_direction(MUTE_ABD_PORT1, 0);
	gpio_set_output_value(MUTE_ABD_PORT1,1);

	gpio_set_pull_up(MUTE_ABD_PORT2, 0);
	gpio_set_pull_down(MUTE_ABD_PORT2, 0);
	gpio_set_direction(MUTE_ABD_PORT2, 0);
	gpio_set_output_value(MUTE_ABD_PORT2,1); //mute
