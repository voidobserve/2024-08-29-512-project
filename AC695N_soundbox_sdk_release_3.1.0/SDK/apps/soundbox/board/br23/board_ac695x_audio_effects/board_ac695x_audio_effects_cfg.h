#ifndef CONFIG_BOARD_AC695X_AUDIO_EFFECTS_CFG_H
#define CONFIG_BOARD_AC695X_AUDIO_EFFECTS_CFG_H

#ifdef CONFIG_BOARD_AC695X_AUDIO_EFFECTS
...
#if (TCFG_MIC_EFFECT_ENABLE && (TCFG_DEC_APE_ENABLE || TCFG_DEC_FLAC_ENABLE || TCFG_DEC_DTS_ENABLE)&&(TCFG_SOUNDBOX_TOOL_ENABLE || TCFG_EFFECT_TOOL_ENABLE))
#error "使能配置工具时，需临时关闭flac解码 !!!"
...
#endif //CONFIG_BOARD_AC695X_AUDIO_EFFECTS
#endif //CONFIG_BOARD_AC695X_AUDIO_EFFECTS_CFG_H
